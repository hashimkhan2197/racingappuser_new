...
import 'package:racingappuser/Screens/ChatScreens/chat_screen.dart';
import 'package:racingappuser/services/chat_service.dart';
...
class _FullScreenMapState extends State<FullScreenMap> {
  ...
  Future<void> getIcons(List<DocumentSnapshot> documentList) async {
...
//    });
    await BitmapDescriptor.fromAssetImage(ImageConfiguration(size: Size(6, 6)),
        'assets/mblue.png')
        .then((d) {
      iconCurrentUser = d;
    });
    if(Provider.of<User>(context).userProfile.email == 'racingapp3@gmail.com'){
      await BitmapDescriptor.fromAssetImage(ImageConfiguration(size: Size(6, 6)),
          'assets/mgreen.png')
          .then((d) {
        iconCurrentUser = d;
